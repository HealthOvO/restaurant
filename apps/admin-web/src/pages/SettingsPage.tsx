...
export function SettingsPage() {
  ...
  async function save(event: FormEvent) {
    ...
    try { setForm(await api.saveStoreConfig(session.token, form)); notify("营业设置已保存", "success"); }
  ...
  return (
    <div className="page-stack settings-page">
      <header className="page-header"><div><p className="eyebrow">摊位信息</p><h1>营业设置</h1><p>暂停接单不会影响查看和处理已有订单。</p></div></header>
      <form className="settings-grid" onSubmit={save}>
        ...
        <section className="panel settings-section">
          ...
          <p className="field-help">例如设置为 04:00，凌晨 1 点的订单仍算前一天。</p>
        </section>
