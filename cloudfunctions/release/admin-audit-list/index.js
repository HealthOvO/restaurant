...
// src/handlers/admin.audit.list.ts
var admin_audit_list_exports = {};
__export(admin_audit_list_exports, {
  main: () => main
});
module.exports = __toCommonJS(admin_audit_list_exports);
...
async function listAuditLogs(repository, token) {
...
var main = defineHandler(
  async ({ event, repository }) => listAuditLogs(repository, event.sessionToken)
);
