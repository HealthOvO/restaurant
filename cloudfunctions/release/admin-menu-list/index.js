...
// src/handlers/admin.menu.list.ts
var admin_menu_list_exports = {};
__export(admin_menu_list_exports, {
  main: () => main
});
module.exports = __toCommonJS(admin_menu_list_exports);
...
async function listAdminMenu(repository, token) {
...
// src/handlers/admin.menu.list.ts
var main = defineHandler(async ({ event, repository }) => {
