...
// src/handlers/admin.feedback.list.ts
var admin_feedback_list_exports = {};
__export(admin_feedback_list_exports, {
  main: () => main
});
module.exports = __toCommonJS(admin_feedback_list_exports);
...
async function listAdminFeedback(repository, input) {
...
// src/handlers/admin.feedback.list.ts
var main = defineHandler(async ({ event, repository }) => listAdminFeedback(repository, event));
