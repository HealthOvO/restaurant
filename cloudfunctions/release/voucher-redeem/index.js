...
// src/handlers/voucher.redeem.ts
var voucher_redeem_exports = {};
__export(voucher_redeem_exports, {
  main: () => main
});
module.exports = __toCommonJS(voucher_redeem_exports);
...
function assertVoucherRedeemable(voucher, now) {
...
// src/handlers/voucher.redeem.ts
var main = defineHandler(async ({ event, repository }) => redeemVoucher(repository, event));
