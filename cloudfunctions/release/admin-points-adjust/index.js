...
// src/handlers/admin.points.adjust.ts
var admin_points_adjust_exports = {};
__export(admin_points_adjust_exports, {
  main: () => main
});
module.exports = __toCommonJS(admin_points_adjust_exports);
...
async function adjustMemberPoints(repository, input) {
...
// src/handlers/admin.points.adjust.ts
var main = defineHandler(async ({ event, repository }) => adjustMemberPoints(repository, event));
