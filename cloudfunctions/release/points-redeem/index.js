...
// src/handlers/points.redeem.ts
var points_redeem_exports = {};
__export(points_redeem_exports, {
  main: () => main
});
module.exports = __toCommonJS(points_redeem_exports);
...
async function redeemPoints(repository, memberId, input) {
