...
// src/handlers/member.feedback.submit.ts
var member_feedback_submit_exports = {};
__export(member_feedback_submit_exports, {
  main: () => main
});
module.exports = __toCommonJS(member_feedback_submit_exports);
...
async function submitMemberFeedback(repository, callerOpenId, input) {
...
var main = defineHandler(
  async ({ event, context, repository }) => submitMemberFeedback(repository, context.OPENID || "", event)
);
