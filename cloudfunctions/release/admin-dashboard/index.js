...
// src/handlers/admin.dashboard.ts
var admin_dashboard_exports = {};
__export(admin_dashboard_exports, {
  main: () => main
});
module.exports = __toCommonJS(admin_dashboard_exports);
...
async function dashboard(repository, token) {
...
var main = defineHandler(
  async ({ event, repository }) => dashboard(repository, event.sessionToken)
);
