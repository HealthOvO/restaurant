...
// src/handlers/member.records.ts
var member_records_exports = {};
__export(member_records_exports, {
  main: () => main
});
module.exports = __toCommonJS(member_records_exports);
...
async function listMemberRecords(repository, memberId) {
