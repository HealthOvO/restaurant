...
// src/handlers/admin.opsTasks.resolve.ts
var admin_opsTasks_resolve_exports = {};
__export(admin_opsTasks_resolve_exports, {
  main: () => main
});
module.exports = __toCommonJS(admin_opsTasks_resolve_exports);
...
async function resolveOpsTask(repository, input) {
...
// src/handlers/admin.opsTasks.resolve.ts
var main = defineHandler(async ({ event, repository }) => resolveOpsTask(repository, event));
