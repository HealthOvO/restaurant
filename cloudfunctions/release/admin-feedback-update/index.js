...
// src/handlers/admin.feedback.update.ts
var admin_feedback_update_exports = {};
__export(admin_feedback_update_exports, {
  main: () => main
});
module.exports = __toCommonJS(admin_feedback_update_exports);
...
async function updateAdminFeedback(repository, input) {
...
// src/handlers/admin.feedback.update.ts
var main = defineHandler(async ({ event, repository }) => updateAdminFeedback(repository, event));
