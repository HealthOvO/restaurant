...
// src/handlers/voucher.listMine.ts
var voucher_listMine_exports = {};
__export(voucher_listMine_exports, {
  main: () => main
});
module.exports = __toCommonJS(voucher_listMine_exports);
...
var main = defineHandler(async ({ context, repository }) => {
  ...
  return listMyVouchers(repository, member._id);
});
