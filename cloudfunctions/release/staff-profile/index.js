...
// src/handlers/staff.profile.ts
var staff_profile_exports = {};
__export(staff_profile_exports, {
  main: () => main
});
module.exports = __toCommonJS(staff_profile_exports);
...
async function getStaffProfile(repository, input) {
...
// src/handlers/staff.profile.ts
var main = defineHandler(async ({ event, repository }) => getStaffProfile(repository, event));
