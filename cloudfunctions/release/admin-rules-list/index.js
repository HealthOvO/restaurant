...
// src/handlers/admin.rules.list.ts
var admin_rules_list_exports = {};
__export(admin_rules_list_exports, {
  main: () => main
});
module.exports = __toCommonJS(admin_rules_list_exports);
...
async function listRules(repository, token) {
...
var main = defineHandler(
  async ({ event, repository }) => listRules(repository, event.sessionToken)
);
