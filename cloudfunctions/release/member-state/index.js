...
// src/handlers/member.state.ts
var member_state_exports = {};
__export(member_state_exports, {
  main: () => main
});
module.exports = __toCommonJS(member_state_exports);
...
async function getMemberState(repository, callerOpenId) {
