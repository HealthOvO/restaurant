...
// src/handlers/visit.settleFirstVisit.ts
var visit_settleFirstVisit_exports = {};
__export(visit_settleFirstVisit_exports, {
  main: () => main
});
module.exports = __toCommonJS(visit_settleFirstVisit_exports);
...
// src/handlers/visit.settleFirstVisit.ts
var main = defineHandler(async ({ event, repository }) => settleFirstVisit(repository, event));
