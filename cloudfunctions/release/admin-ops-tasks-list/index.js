...
// src/handlers/admin.opsTasks.list.ts
var admin_opsTasks_list_exports = {};
__export(admin_opsTasks_list_exports, {
  main: () => main
});
module.exports = __toCommonJS(admin_opsTasks_list_exports);
...
function compareOpsTasks(left, right) {
  const priorityWeight = {
    URGENT: 3,
    HIGH: 2,
    NORMAL: 1
  };
  return priorityWeight[right.priority] - priorityWeight[left.priority] || right.updatedAt.localeCompare(left.updatedAt) || right.createdAt.localeCompare(left.createdAt);
}
async function listOpsTasks(repository, input) {
...
// src/handlers/admin.opsTasks.list.ts
var main = defineHandler(async ({ event, repository }) => listOpsTasks(repository, event));
