...
// src/handlers/member.feedback.mine.ts
var member_feedback_mine_exports = {};
__export(member_feedback_mine_exports, {
  main: () => main
});
module.exports = __toCommonJS(member_feedback_mine_exports);
...
async function listMyMemberFeedback(repository, callerOpenId) {
...
var main = defineHandler(
  async ({ context, repository }) => listMyMemberFeedback(repository, context.OPENID || "")
);
